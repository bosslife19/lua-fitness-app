...
const AddWorkoutPage = ({ navigation, addWorkout }) => {
  ...
  const handleAddWorkout = () => {
    if (!workoutType || !workoutDuration || !equipment) return;

    const newWorkout = {
      day: "Mon",
      cardio: workoutType,
      date: new Date().toDateString(),
      status: { completed: false, missed: false, scheduled: true },
      equipment,
      trainerNotes,
    };
  ...
  return (
    <>
      ...
      <RNPickerSelect
        ...
        placeholder={{ label: "Workout type", value: "" }}
        style={pickerStyles}
      />
         <RNPickerSelect
        onValueChange={setEquipment}
        ...
        placeholder={{ label: "Workout Duration", value: "" }}
        style={pickerStyles}
      />
        ...
        <TextInput
          ...
          style={[styles.input,{paddingBottom:50}]}
          multiline
        />
