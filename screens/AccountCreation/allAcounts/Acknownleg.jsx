  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <Text style={styles.desc}>
        Before proceeding, please review and agree to our <Text style={{color:"#8A2BE2", textDecorationLine:"underline"}}> Informed Consent and
        Acknowledgment Agreement, Privacy Policy,</Text> and <Text style={{color:"#8A2BE2", textDecorationLine:"underline"}}>User Agreement.</Text>
      </Text>
